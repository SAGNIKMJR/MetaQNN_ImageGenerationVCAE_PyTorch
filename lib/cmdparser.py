...
parser.add_argument('-qstep', '--qstore-enc-path', metavar='QSTEP', default = None,
                    help='path to stored q values for encoder (default: None)')
parser.add_argument('-qstdp', '--qstore-dec-path', metavar='QSTDP', default = None,
                    help='path to stored q values for decoder (default: None)')
