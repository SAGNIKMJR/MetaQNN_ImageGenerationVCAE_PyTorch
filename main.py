...
def main():
	...
	gen = QLearner(state_space_parameters, 1, WeightInitializer, device, args, save_path, qstore_enc = args.qstore_enc_path,\
				 qstore_dec = args.qstore_dec_path, replaydict = args.replay_dict_path)
